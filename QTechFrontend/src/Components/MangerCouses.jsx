...
const MangerCouses = ({ setSelectedComponent, selectedComponent }) => {
  const menuItems = [
    { id: "Admin", label: "Admins", desc: "Manage Admins", icon: <FaUserShield /> },
  ...
  return (
    <div className="w-full h-screen sticky top-0 flex flex-col bg-white shadow-md border-r border-gray-300">
      {/* Actions Heading */}
